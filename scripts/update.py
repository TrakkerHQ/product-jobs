#!/usr/bin/env python3
"""Pull Trakker's PM, TPM postings and regenerate the README tables.

Runs once a day from .github/workflows/refresh.yml. Each run:

1. fetches every PM / TPM intern/new-grad posting Trakker considers new in the
...
def fetch() -> list[dict]:
    ...
    request = urllib.request.Request(url, headers={
        ...
        "User-Agent": "trakker-product-jobs/1.0 (+https://github.com/TrakkerHQ/product-jobs)",
    })
    try:
